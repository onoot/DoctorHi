...
CREATE DATABASE IF NOT EXISTS doctor_heights;
...
-- Создание администратора по умолчанию с захешированным паролем 'admin123'
INSERT INTO users (name, email, password, cnic, role)
VALUES (
  'Admin',
  'admin@doctorheights.pk',
  '$2a$10$8K1p/a0dL1LXMIZoIqvyW.XbI5Br6QJG5AGIQpRwYjqD3BzNKGYgC',
  '0000000000000',
  'admin'
)
